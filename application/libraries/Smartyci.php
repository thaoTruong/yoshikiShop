...
class Smartyci extends Smarty
{
	public function __construct()
	{
		...
		$this->setCompileDir( $config['application_dir'] . 'third_party/Smarty-3.1.21/templates_c' );
		$this->setConfigDir( $config['application_dir'] . 'third_party/Smarty-3.1.21/configs' );
